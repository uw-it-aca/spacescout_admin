...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Space.is_deleted'
        db.add_column('spacescout_admin_space', 'is_deleted',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Space.is_deleted'
        db.delete_column('spacescout_admin_space', 'is_deleted')
